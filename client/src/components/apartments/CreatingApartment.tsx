...
import { CreateApartmentViewModel } from "../../viewmodels/authenticated/states/apartments/create";
import { RealtorPicker} from "./RealtorPicker";

@observer
export class CreateApartment extends React.Component<{
  viewModel: CreateApartmentViewModel,
}> {
  public render() {
    return (
      <Card
